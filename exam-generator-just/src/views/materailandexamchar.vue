...
<p class="yourfile" v-show="uploaded">uploaded file: {{ uploadefile }}</p>
<div class="orline">
    <div class="line_before"></div><p class="or">or</p><div class="line_after"></div>
</div>
</div>
<div class="writeText"> 
<textarea type="text" v-model="text" placeholder="Type here..." class="textbox" :disabled="uploaded"></textarea>
</div>
 </div>
 <div class="examchar">
    ...
    <div class="dificulty_level">
     <div class="choices"><label class="easy">Easy</label><p class="plus" @click="maximize1()" >+</p><input class="levels" v-model="easy" type="number"><p class="minus" @click="minimize1()">-</p></div>
     <div class="choices"><label class="mid">Mid</label><p class="plus" @click="maximize2()">+</p><input class="levels" v-model="mid" type="number"><p class="minus" @click="minimize2()">-</p></div>
     <div class="choices"><label class="hard">Hard</label><p class="plus" @click="maximize3()">+</p><input class="levels" v-model="hard" type="number"><p class="minus" @click="minimize3()">-</p></div>
    </div>
</div>
    <div class="number_of_options">
        <div class="char_title">
        
     <h4>Number of options</h4></div>
     <div class="range"><input class="range_slider"  type="range" min="2" max="6"  v-model="numOfOPtions"></div>
...
<div v-for="data ,i=1 in responsedata" class="mcq">
<h2>{{ data.mcq }}</h2>
<div v-for="dataoption in data.option">
<h5>{{ dataoption }}</h5>
</div>
...
methods:{
    async test(){
  try{ const response=await axios.post('http://127.0.0.1:5173/generate-exam',{
    text:this.text,
