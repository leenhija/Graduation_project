...
// var content=`<div v-for='data in responsedata' class='mcq'><h2></h2><div v-for='(dataoption,c) in data.option'><h5>{{ c }} )</h5><h5>{{ dataoption }}</h5></div></div>`
export default {
    components: {
    ...
    methods: {
        async test() {
            try {
                const response = await axios.post('http://127.0.0.1:5173/generate-exam', {
                    text: this.text,
                ...
                this.newtext = `<h2>${response.data}</h2>`;

                //    document.getElementById("quill").innerHTML=contet;
...
<template>
    ...
    <form class="generation" @submit.prevent="test()">
        <div class="material">
            ...
            <div class="writeText">
                <textarea type="text" v-model="text" placeholder="Type here..." class="textbox"
                    :disabled="uploaded"></textarea>
            </div>
        </div>
        <div class="examchar">
            <div class="diificulty">
                ...
                <div class="dificulty_level">
                    <div class="choices"><label class="easy">Easy</label>
                        <p class="plus" @click="maximize1()">+</p><input class="levels" v-model="easy" type="number">
                        <p class="minus" @click="minimize1()">-</p>
                    </div>
                    <div class="choices"><label class="mid">Mid</label>
                        <p class="plus" @click="maximize2()">+</p><input class="levels" v-model="mid" type="number">
                        <p class="minus" @click="minimize2()">-</p>
                    </div>
                    <div class="choices"><label class="hard">Hard</label>
                        <p class="plus" @click="maximize3()">+</p><input class="levels" v-model="hard" type="number">
            ...
            <div class="number_of_options">
                ...
                <div class="range"><input class="range_slider" type="range" min="2" max="6" v-model="numOfOPtions">
                </div>
        ...
        <div class="container">
         <div v-for="data in responsedata" class="mcq">
