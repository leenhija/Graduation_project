...
<input type="text" id="username" autocomplete="off" placeholder="Username" v-model="username" required @keyup.enter="focusNextInput($event,'phonenumber')" @input="validateUsername"/>
<small id="username-error" v-show="username_rules">your user name should consist of at least 6 characters</small>
</div>
<div class="input-group phone-group">
<input type="tel" id="phone" autocomplete="off" placeholder="Phone Number" v-model="phonenumber" required maxlength="10" @input="validatephonenumber">
<small id="phone-error" v-show="phone_rules">your phone number must start with 0</small>
</div>
<div class="input-group email-group">
<input type="email" id="email" autocomplete="off" placeholder="Email Address" v-model="email" @input="validateEmail" required/> 
<small id="email-error" v-show="email_rules">valid email : user@example.com</small>
</div>
...
validateEmail() {
    ...
    validateUsername(){
      if(this.username.length<6){
        ...
        document.getElementById("username").setAttribute("style","border-color: rgb(76, 207, 76)");
        this.username_rules=false;
      }
    },
    validatephonenumber(){
      this.handelphonenumber();
      if(this.phonenumber.length==10 && this.phonenumber.substring(0,1)=='0'){
    ...
    validatePassword(){
        ...
        async verify(){
          const verify= await axios.post(`send`,{
          email:this.email
        })
        }
}
